ATTRIBUTE_DEFINITIONS = {
    "Inappropriateness": "We deem an argument inappropriate (in light of its discussion context) if it is missing commitment ofits author to the discussion, uses toxic emotions, is missing intelligibility, or seems inappropriate for other reasons",
